...
- **2.3.0 Version (2026-01-26)**
  - **용돈기입장 날짜 입력 유연성 강화**: 사용자가 날짜를 명시하지 않고 "500원 꽝 사먹음"과 같이 입력하더라도 자동으로 오늘 날짜로 기록되도록 개선
  - **자녀 프로필 UI 직관성 개선**: 용돈기입장의 '남은 돈' 표기를 '잔액'으로 변경하고, 수입/지출을 뱃지와 색상으로 명확히 구분하여 아이들이 이해하기 쉽도록 디자인 개선
